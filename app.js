const keyboard = {
   key_layout : {
      eng_layout : [ "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "","q", ["q", 'ဈ', 'ဆ'], ["w", 'ဝ', 'တ'], ["e", 'ဣ', 'န'], ["r", '၎င်း', 'မ'], ["t", 'ဤ','အ'], ["y", '၌', 'ပ'], ["u", 'ဥ', 'က'], ["i", '၍', 'င'], ["o", 'ဿသ], "pဏစ", "&ဧဟ", "&ဪဩ","backspace","cap", "aဗ‌ေ", "sှျ", "dီိိိ ိ", "f်", "gွါ", "hံ ့", "jဲ ြ", "kဒ ု", "lဓ ူ", "&ဂ း" "&၏","enter","", "zဇဖ", "xဌထ", "cဃခ", "vဠလ", "bယဘ", "nဉ ည", "mဦ ာ", ",၊ ။", ".", "?","space"]
   },
